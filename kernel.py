...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep  8 22:37:55 2018
...
fig.savefig(ship_dir+'overview.png')
...
weight_path = ship_dir+"{}_weights.best.hdf5".format('seg_model')
...
seg_model.save(ship_dir+'seg_model.h5')
...
fullres_model.save(ship_dir+'fullres_model.h5')
...
fig.savefig(ship_dir+'validation.png')
...
sub1 = pd.read_csv(ship_dir+'sample_submission.csv')
...
print(len(sub))
sub.to_csv(ship_dir+'submission.csv', index=False)
sub.head()
