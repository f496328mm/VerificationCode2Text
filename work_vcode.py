...
#os.getcwd()
FONTPATH = ["/home/linsam/project/fb_chatbot/verification_code2text/Times Bold.ttf",
            "/home/linsam/project/fb_chatbot/verification_code2text/Courier-BoldRegular.ttf"]
...
def work_vcode_fun(amount,file_path,amount2):# amount = 5 ; file_path = 'test_data'
    ...
    for index in range(amount):
        ...
        captcha.convert("RGB").save(tem + file_path + "/" + numberstr + ".jpg", "JPEG")
